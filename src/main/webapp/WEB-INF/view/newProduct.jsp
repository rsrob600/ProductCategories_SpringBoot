...
<head>
	...
	<title>ProductCategories | New Product</title>
</head>
<body>
		...
		<div class="container">
			<div class="row justify-content-md-center">
				<div class="col-md-auto">
					<h1 class="mb-4 font-weight-light">New Product</h1>
				</div>
			</div>
		</div>
			
		<div class="d-flex justify-content-center align-items-center container">
			<form:form class="form-horizontal" action="/addProduct" method="post" modelAttribute="product">
